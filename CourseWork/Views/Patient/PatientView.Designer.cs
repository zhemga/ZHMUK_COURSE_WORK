namespace CourseWork.Views.PatientView {
    partial class PatientView {
		...
		private void InitializeComponent() {
			...
			this.patientViewBindingSource.DataSource = typeof(CourseWork.Model.Patient);
			this.dataLayoutControl1.DataSource = patientViewBindingSource;
			//
			//Create GridControls
			//
            ...
            this.mvvmContext.ViewModelType = typeof(CourseWork.ViewModels.PatientViewModel);
			// 
            // labelControl
            // 
            this.labelControl.Dock = System.Windows.Forms.DockStyle.Top;
            this.labelControl.Name = "labelControl";
            this.labelControl.Text = "Patient - Element View";
