...
using CourseWork.Views.Tasks;

namespace CourseWork.Views.ClinicDbContextView{
    public partial class ClinicDbContextView : XtraUserControl {
        ...
        void InitializeNavigation() {
            ...
            this.navigationFrame.AddPage(new ScheduleAttendanceReportView());
        }

        private void scheduleAttendanceReportItem_ItemClick(object sender, TileItemEventArgs e)
        {
