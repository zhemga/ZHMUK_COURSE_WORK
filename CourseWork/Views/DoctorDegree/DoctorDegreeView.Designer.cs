namespace CourseWork.Views.DoctorDegreeView {
    partial class DoctorDegreeView {
        /// <summary> 
		...
		private void InitializeComponent() {
			...
			this.doctorDegreeViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.doctorDegreeViewBindingSource.DataSource = typeof(CourseWork.Model.DoctorDegree);
			this.dataLayoutControl1.DataSource = doctorDegreeViewBindingSource;
			//
			//Create GridControls
			//
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters FullNameDoctorsChildPopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            FullNameDoctorsChildPopulateColumnParameters_NotVisible.FieldName = "FullName";
		    FullNameDoctorsChildPopulateColumnParameters_NotVisible.ColumnVisible = false;
			DoctorsPopulateColumnsParameters.CustomColumnParameters.Add(FullNameDoctorsChildPopulateColumnParameters_NotVisible);
				
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters PopularityDoctorsChildPopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            PopularityDoctorsChildPopulateColumnParameters_NotVisible.FieldName = "Popularity";
		    PopularityDoctorsChildPopulateColumnParameters_NotVisible.ColumnVisible = false;
			DoctorsPopulateColumnsParameters.CustomColumnParameters.Add(PopularityDoctorsChildPopulateColumnParameters_NotVisible);
            ...
            DoctorsDoctorsChildPopulateColumnParameters.Path = "Doctors.FullName";
            ...
            this.mvvmContext.ViewModelType = typeof(CourseWork.ViewModels.DoctorDegreeViewModel);
			// 
            // labelControl
            // 
            this.labelControl.Dock = System.Windows.Forms.DockStyle.Top;
            this.labelControl.Name = "labelControl";
            this.labelControl.Text = "DoctorDegree - Element View";
		...
		private System.Windows.Forms.BindingSource doctorDegreeViewBindingSource;
