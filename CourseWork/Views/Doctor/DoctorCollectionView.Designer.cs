namespace CourseWork.Views.DoctorCollectionView {
    partial class DoctorCollectionView {
		...
		private void InitializeComponent() {
			...
			this.gridControl.DataSource = doctorCollectionViewBindingSource;
			...
			//DoctorDegree
			//
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters DoctorDegreePopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            DoctorDegreePopulateColumnParameters.FieldName = "DoctorDegree";
            DoctorDegreePopulateColumnParameters.Path = "DoctorDegree.Name";
			parameters.CustomColumnParameters.Add(DoctorDegreePopulateColumnParameters);
						DevExpress.XtraGrid.Extensions.PopulateColumnParameters DoctorDegreePopulateColumnParameters_NotGenerate = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            DoctorDegreePopulateColumnParameters_NotGenerate.FieldName = "DoctorDegreeId";
		    DoctorDegreePopulateColumnParameters_NotGenerate.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(DoctorDegreePopulateColumnParameters_NotGenerate);
									//
			//DoctorProfile
			//
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters DoctorProfilePopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            DoctorProfilePopulateColumnParameters.FieldName = "DoctorProfile";
            DoctorProfilePopulateColumnParameters.Path = "DoctorProfile.Name";
			parameters.CustomColumnParameters.Add(DoctorProfilePopulateColumnParameters);
						DevExpress.XtraGrid.Extensions.PopulateColumnParameters DoctorProfilePopulateColumnParameters_NotGenerate = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            DoctorProfilePopulateColumnParameters_NotGenerate.FieldName = "DoctorProfileId";
		    DoctorProfilePopulateColumnParameters_NotGenerate.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(DoctorProfilePopulateColumnParameters_NotGenerate);
										
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters DoctorProfilePopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            DoctorProfilePopulateColumnParameters_NotVisible.FieldName = "DoctorProfile";
		    DoctorProfilePopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(DoctorProfilePopulateColumnParameters_NotVisible);
				
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters DoctorDegreePopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            DoctorDegreePopulateColumnParameters_NotVisible.FieldName = "DoctorDegree";
		    DoctorDegreePopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(DoctorDegreePopulateColumnParameters_NotVisible);
			...
			this.gridView.PopulateColumns(typeof(CourseWork.Model.Doctor),parameters);
		    // 
            // mvvmContext
            // 
