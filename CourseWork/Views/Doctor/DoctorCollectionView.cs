...
namespace CourseWork.Views.DoctorCollectionView{
    public partial class DoctorCollectionView : XtraUserControl {
        public DoctorCollectionView() {
            InitializeComponent();
			if(!mvvmContext.IsDesignMode)
                InitBindings();
        }
        void InitBindings() {
            var fluentAPI = mvvmContext.OfType<CourseWork.ViewModels.DoctorCollectionViewModel>();
        ...
        private void selectMostPopularDoctorButton_Click(object sender, EventArgs e)
        {
            this.gridColumn11.SortOrder = DevExpress.Data.ColumnSortOrder.Descending;
