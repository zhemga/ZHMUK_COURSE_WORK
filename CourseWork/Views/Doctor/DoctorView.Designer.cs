namespace CourseWork.Views.DoctorView {
    partial class DoctorView {
		...
		private void InitializeComponent() {
			...
			this.DoctorDegreeLookUpEdit.Properties.ValueMember = "Name"; 
			...
			this.DoctorDegreeLookUpEdit.DataBindings.Add("EditValue", doctorViewBindingSource, "DoctorDegreeName", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
            ...
            DoctorDegreeLookUpEditRetrieveFieldParameters.FieldName = "DoctorDegreeName";
			...
			this.DoctorProfileLookUpEdit.Properties.ValueMember = "Name"; 
			...
			this.DoctorProfileLookUpEdit.DataBindings.Add("EditValue", doctorViewBindingSource, "DoctorProfileName", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
            ...
            DoctorProfileLookUpEditRetrieveFieldParameters.FieldName = "DoctorProfileName";
