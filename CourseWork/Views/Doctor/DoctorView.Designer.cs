    ...
    partial class DoctorView {
		...
		private void InitializeComponent() {
			...
			this.ScheduleOfficeHoursPopUpMenu = new DevExpress.XtraBars.PopupMenu(this.components);
						...
						((System.ComponentModel.ISupportInitialize)(this.ScheduleOfficeHoursBarManager)).BeginInit();
									this.DoctorDegreeLookUpEdit = new DevExpress.XtraEditors.GridLookUpEdit();
			this.DoctorDegreeBindingSource = new System.Windows.Forms.BindingSource(this.components);
						this.DoctorProfileLookUpEdit = new DevExpress.XtraEditors.GridLookUpEdit();
			this.DoctorProfileBindingSource = new System.Windows.Forms.BindingSource(this.components);
			...
			this.doctorViewBindingSource.DataSource = typeof(CourseWork.Model.Doctor);
			this.dataLayoutControl1.DataSource = doctorViewBindingSource;
			//
			//Create GridControls
			//
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters DoctorDegreeScheduleOfficeHoursChildPopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            DoctorDegreeScheduleOfficeHoursChildPopulateColumnParameters.FieldName = "DoctorDegreeScheduleOfficeHours";
            DoctorDegreeScheduleOfficeHoursChildPopulateColumnParameters.Path = "DoctorDegree.Name";
			ScheduleOfficeHoursPopulateColumnsParameters.CustomColumnParameters.Add(DoctorDegreeScheduleOfficeHoursChildPopulateColumnParameters);
				
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters DoctorProfileScheduleOfficeHoursChildPopulateColumnParameters = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            DoctorProfileScheduleOfficeHoursChildPopulateColumnParameters.FieldName = "DoctorProfileScheduleOfficeHours";
            DoctorProfileScheduleOfficeHoursChildPopulateColumnParameters.Path = "DoctorProfile.Name";
			ScheduleOfficeHoursPopulateColumnsParameters.CustomColumnParameters.Add(DoctorProfileScheduleOfficeHoursChildPopulateColumnParameters);
            ...
            ScheduleOfficeHoursScheduleOfficeHoursChildPopulateColumnParameters.Path = "ScheduleOfficeHours.Description";
			...
			parameters.CustomListParameters.Add(ScheduleOfficeHoursRetriveFieldParameters);
									//
			//DoctorDegreeLookUpEdit
			//
			this.DoctorDegreeBindingSource.DataSource = typeof(CourseWork.Model.DoctorDegree);
			this.DoctorDegreeLookUpEdit.Properties.ValueMember = "Id"; 
			this.DoctorDegreeLookUpEdit.Properties.DisplayMember = "Name";
			this.DoctorDegreeLookUpEdit.Properties.DataSource = this.DoctorDegreeBindingSource;
			this.DoctorDegreeLookUpEdit.Name = "DoctorDegreeLookUpEdit";
			this.DoctorDegreeLookUpEdit.DataBindings.Add("EditValue", doctorViewBindingSource, "DoctorDegreeId", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
			DevExpress.XtraDataLayout.RetrieveFieldParameters DoctorDegreeLookUpEditRetrieveFieldParameters = new DevExpress.XtraDataLayout.RetrieveFieldParameters();
            DoctorDegreeLookUpEditRetrieveFieldParameters.FieldName = "DoctorDegreeId";
            DoctorDegreeLookUpEditRetrieveFieldParameters.ControlForField = this.DoctorDegreeLookUpEdit;
			parameters.CustomListParameters.Add(DoctorDegreeLookUpEditRetrieveFieldParameters);
			DevExpress.XtraDataLayout.RetrieveFieldParameters DoctorDegreeLookUpEditRetrieveFieldParameters_NotGenerate = new DevExpress.XtraDataLayout.RetrieveFieldParameters();
		    DoctorDegreeLookUpEditRetrieveFieldParameters_NotGenerate.FieldName = "DoctorDegree";
		    DoctorDegreeLookUpEditRetrieveFieldParameters_NotGenerate.GenerateField = false;
			parameters.CustomListParameters.Add(DoctorDegreeLookUpEditRetrieveFieldParameters_NotGenerate);
						//
			//DoctorProfileLookUpEdit
			//
			this.DoctorProfileBindingSource.DataSource = typeof(CourseWork.Model.DoctorProfile);
			this.DoctorProfileLookUpEdit.Properties.ValueMember = "Id"; 
			this.DoctorProfileLookUpEdit.Properties.DisplayMember = "Name";
			this.DoctorProfileLookUpEdit.Properties.DataSource = this.DoctorProfileBindingSource;
			this.DoctorProfileLookUpEdit.Name = "DoctorProfileLookUpEdit";
			this.DoctorProfileLookUpEdit.DataBindings.Add("EditValue", doctorViewBindingSource, "DoctorProfileId", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
			DevExpress.XtraDataLayout.RetrieveFieldParameters DoctorProfileLookUpEditRetrieveFieldParameters = new DevExpress.XtraDataLayout.RetrieveFieldParameters();
            DoctorProfileLookUpEditRetrieveFieldParameters.FieldName = "DoctorProfileId";
            DoctorProfileLookUpEditRetrieveFieldParameters.ControlForField = this.DoctorProfileLookUpEdit;
			parameters.CustomListParameters.Add(DoctorProfileLookUpEditRetrieveFieldParameters);
			DevExpress.XtraDataLayout.RetrieveFieldParameters DoctorProfileLookUpEditRetrieveFieldParameters_NotGenerate = new DevExpress.XtraDataLayout.RetrieveFieldParameters();
		    DoctorProfileLookUpEditRetrieveFieldParameters_NotGenerate.FieldName = "DoctorProfile";
		    DoctorProfileLookUpEditRetrieveFieldParameters_NotGenerate.GenerateField = false;
			parameters.CustomListParameters.Add(DoctorProfileLookUpEditRetrieveFieldParameters_NotGenerate);
            ...
            this.mvvmContext.ViewModelType = typeof(CourseWork.ViewModels.DoctorViewModel);
			// 
            // labelControl
            // 
            this.labelControl.Dock = System.Windows.Forms.DockStyle.Top;
            this.labelControl.Name = "labelControl";
            this.labelControl.Text = "Doctor - Element View";
		...
		private DevExpress.XtraBars.PopupMenu ScheduleOfficeHoursPopUpMenu;
				...
				private DevExpress.XtraBars.BarButtonItem bbiScheduleOfficeHoursRefresh;
								private DevExpress.XtraEditors.GridLookUpEdit DoctorDegreeLookUpEdit;
		private System.Windows.Forms.BindingSource DoctorDegreeBindingSource;
				private DevExpress.XtraEditors.GridLookUpEdit DoctorProfileLookUpEdit;
		private System.Windows.Forms.BindingSource DoctorProfileBindingSource;
