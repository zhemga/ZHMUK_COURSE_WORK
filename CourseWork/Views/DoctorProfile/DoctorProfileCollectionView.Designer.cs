namespace CourseWork.Views.DoctorProfileCollectionView {
    partial class DoctorProfileCollectionView {
        /// <summary> 
		...
		private void InitializeComponent() {
            ...
            this.labelControl.Text = "DoctorProfile";
			// 
            // gridControl
            // 
			...
			this.doctorProfileCollectionViewBindingSource = new System.Windows.Forms.BindingSource(this.components);
			this.doctorProfileCollectionViewBindingSource.DataSource = typeof(CourseWork.Model.DoctorProfile);
			this.gridControl.DataSource = doctorProfileCollectionViewBindingSource;
			...
			DevExpress.XtraGrid.Extensions.PopulateColumnParameters DoctorsPopulateColumnParameters_NotVisible = new DevExpress.XtraGrid.Extensions.PopulateColumnParameters();
            DoctorsPopulateColumnParameters_NotVisible.FieldName = "Doctors";
		    DoctorsPopulateColumnParameters_NotVisible.ColumnVisible = false;
			parameters.CustomColumnParameters.Add(DoctorsPopulateColumnParameters_NotVisible);
			 
			this.gridView.PopulateColumns(typeof(CourseWork.Model.DoctorProfile),parameters);
		    // 
            // mvvmContext
            // 
            this.mvvmContext.ContainerControl = this;
            this.mvvmContext.ViewModelType = typeof(CourseWork.ViewModels.DoctorProfileCollectionViewModel);
			// 
            // layoutControl
            // 
            ...
            this.Name = "DoctorProfileCollectionView";
		...
		private System.Windows.Forms.BindingSource doctorProfileCollectionViewBindingSource;
