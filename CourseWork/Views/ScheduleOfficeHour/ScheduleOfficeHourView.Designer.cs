namespace CourseWork.Views.ScheduleOfficeHourView {
    partial class ScheduleOfficeHourView {
		...
		private void InitializeComponent() {
			...
			this.DoctorLookUpEdit.Properties.DisplayMember = "Name";
			...
			this.PatientLookUpEdit.Properties.DisplayMember = "Name";
			...
			this.ScheduleOfficeHourStatusLookUpEdit.Properties.ValueMember = "Id"; 
			...
			this.ScheduleOfficeHourStatusLookUpEdit.DataBindings.Add("EditValue", scheduleOfficeHourViewBindingSource, "ScheduleOfficeHourStatusStatusId", true, System.Windows.Forms.DataSourceUpdateMode.OnPropertyChanged);
            ...
            ScheduleOfficeHourStatusLookUpEditRetrieveFieldParameters.FieldName = "ScheduleOfficeHourStatusStatusId";
