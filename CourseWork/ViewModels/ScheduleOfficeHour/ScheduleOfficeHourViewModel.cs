...
namespace CourseWork.ViewModels {
    ...
    /// </summary>
    public partial class ScheduleOfficeHourViewModel : SingleObjectViewModel<ScheduleOfficeHour, Guid, IClinicDbContextUnitOfWork> {
        ...
        protected ScheduleOfficeHourViewModel(IUnitOfWorkFactory<IClinicDbContextUnitOfWork> unitOfWorkFactory = null)
            : base(unitOfWorkFactory ?? UnitOfWorkSource.GetUnitOfWorkFactory(), x => x.ScheduleOfficeHours, x => x.ScheduleOfficeHourStatusStatusName) {
                }
