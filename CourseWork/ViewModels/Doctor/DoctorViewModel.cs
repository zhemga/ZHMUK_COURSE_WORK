...
namespace CourseWork.ViewModels {
    ...
    /// </summary>
    public partial class DoctorViewModel : SingleObjectViewModel<Doctor, Guid, IClinicDbContextUnitOfWork> {
        ...
        protected DoctorViewModel(IUnitOfWorkFactory<IClinicDbContextUnitOfWork> unitOfWorkFactory = null)
            : base(unitOfWorkFactory ?? UnitOfWorkSource.GetUnitOfWorkFactory(), x => x.Doctors, x => x.FullName) {
                }
        ...
        /// </summary>
        public CollectionViewModelBase<ScheduleOfficeHour, ScheduleOfficeHour, Guid, IClinicDbContextUnitOfWork> DoctorScheduleOfficeHoursDetails {
            get {
