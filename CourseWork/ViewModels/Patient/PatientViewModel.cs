...
namespace CourseWork.ViewModels {
    ...
    /// </summary>
    public partial class PatientViewModel : SingleObjectViewModel<Patient, Guid, IClinicDbContextUnitOfWork> {
        ...
        protected PatientViewModel(IUnitOfWorkFactory<IClinicDbContextUnitOfWork> unitOfWorkFactory = null)
            : base(unitOfWorkFactory ?? UnitOfWorkSource.GetUnitOfWorkFactory(), x => x.Patients, x => x.FullName) {
                }
        ...
        /// </summary>
        public CollectionViewModelBase<ScheduleOfficeHour, ScheduleOfficeHour, Guid, IClinicDbContextUnitOfWork> PatientScheduleOfficeHoursDetails {
            get {
